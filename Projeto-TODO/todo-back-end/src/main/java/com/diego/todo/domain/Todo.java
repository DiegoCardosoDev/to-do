...
@Entity // a classe sera uma entidade na base de dados
public class Todo implements Serializable {

	private static final long serialVersionUID = 1L;// Serializable

	@Id // id é uma chave primaria(o id serpa gerado automaticamente)
	@GeneratedValue(strategy = GenerationType.IDENTITY) // gerar id automaticamente

	
	//atributos encapsulados (POO-Encapsulamento)
	private Integer id;
